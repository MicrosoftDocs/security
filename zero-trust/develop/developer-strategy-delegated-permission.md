...
:::image type="content" source="../media/diagram-effective-permissions.png" alt-text="Venn diagram shows left circle description as 'Apps are granted consent for the app's range of operation,' right circle description as 'Users have permissions for operations managed by their organization,' and intersection of circles description as 'Effective permissions: intersection of app permissions and user capabilities.'" lightbox="../media/diagram-effective-permissions.png" :::
