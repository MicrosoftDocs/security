...
See also Microsoft's [Threat Modeling AI/ML Systems and Dependencies](./threat-modeling-aiml) and [SDL Bug Bar Pivots for Machine Learning Vulnerabilities](./security/bug-bar-aiml).
...
failure modes and jumping into the [threat modeling document](./threat-modeling-aiml). This way,
