...
[:::image type="content" source="media/identity-device-overview-steps.png" alt-text="Zero Trust identity and device access policies" lightbox="media/identity-device-overview-steps.png":::](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/media/devices/identity-device-overview-steps.png)

In this illustration:

- In Step 1, [**Implement Level 2 App Protection Policies (APP)**](/microsoft-365/solutions/manage-devices-with-intune-app-protection?view=o365-worldwide) you configure the recommended level of data protection with APP policies. Then you work with your identity team to configure the related Conditional Access rule to require use of this protection.
...
:::image type="content" source="media/devices-enroll-onboard-process.png" alt-text="Process for enrolling and onboarding devices" lightbox="media/devices-enroll-onboard-process.png":::
