...
- Microsoft's Detection and Response Team (DART) ransomware [approach](/security/ransomware/incident-response-playbook-dart-ransomware-approach) and [case study](dart-ransomware-case-study.md)
