...
- [Set the Microsoft 365 apps update channel using the Microsoft Intune settings catalog](/deployoffice/updates/change-update-channels)
- [Microsoft Intune Enterprise Application Management](/mem/intune/apps/apps-enterprise-app-management)
...
- [Strengthen your security posture with Microsoft Defender XDR](/defender-xdr/microsoft-365-security-center-defender-cloud)
...
- [Asset discovery](/defender-vulnerability-management/defender-vulnerability-management#continuous-asset-discovery-and-monitoring)
- [Scan and remediate endpoints](/defender-vulnerability-management/tvm-remediation)
