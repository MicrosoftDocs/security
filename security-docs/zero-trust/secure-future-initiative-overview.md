...
**[Microsoft 365](https://cdn-dynmedia-1.microsoft.com/is/content/microsoftcorp/microsoft/bade/documents/products-and-services/en-us/security/sfi-nov-2025-progress-report.pdf#page=19)** provided increased AI control and data security. | **Innovate**:  Microsoft 365 introduced a dedicated AI Admin role to secure Copilot management without use of the Global Administrator role and enforce least-privilege principles. Centralized agent control and governance allows IT admins to easily manage, configure, and monitor Microsoft 365 agents installed on endpoints.<br/><br/> **Implement**: Compliance at scale with Microsoft Purview adaptive labelling now classifying and securing more thatn 50 million items monthly. | **Guidance**: Guiding customers to use the AI admin roles for Copilot tasks, enforcing least-privilege. Use of Microsoft Purview DSPM for AI to monitor Copilot data usage, and detect misuse.
