...
- [Discover your assets](https://learn.microsoft.com/azure/external-attack-surface-management/what-is-discovery).
- Use Microsoft Security Exposure Management's [attack path analysis](https://learn.microsoft.com/security-exposure-management/cross-workload-attack-surfaces) to find internet-exposed assets with critical vulnerabilities.
