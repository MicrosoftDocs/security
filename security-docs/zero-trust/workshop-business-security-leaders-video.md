...
:::image type="content" source="./media/security-executive-workshop-part-c.png" alt-text="Diagram showing CISO workshop Part C covering the five security disciplines: Access Control, Security Operations, Asset Protection, Security Governance, and Innovation Security." lightbox="./media/security-executive-workshop-part-c-large.png":::
