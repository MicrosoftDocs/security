...
:::image type="content" source="../media/adoption-guide/xyz.svg" alt-text="Diagram of ." lightbox="../media/adoption-guide/xyz.svg":::
...
Outcomes| Stakeholder team

Technical plans

Skills readiness| Evaluate

Test

Pilot| Incrementally implement across your digital estate| Track and measure
...
| - |
| Traditional protection relies on security specialists that are part of the IT team. Security is an IT function.| Security is a responsibility shared among all levels of the business. Accountability for security rests with the executive, while responsibility is shared using the three Zero trust principles of assume breach, verify explicitly, and least privilege.
...
Similar to the tabletop exercises, the output from this more formal review of your organization’s risks feed into your overall strategy and priorities. This should also help create urgency and investment across your teams to participate in modernizing your security posture.
...
![A blue arrow with white text

Description automatically generated with medium confidence](../media/article-6-rapidly-modernize-your-security-posture-03.png)
...
Description automatically generated](../media/article-6-rapidly-modernize-your-security-posture-04.png)
...
Capture your initial Secure Score status

Identify regulatory requirements

Set leadership expectations| Develop a response readiness plan

Inventory your digital estate

Implement basic hygiene practices

Update your status for Secure Score

Capture your status in Compliance Manager| Visualize your security posture using audience-appropriate dashboards

Document and manage shadow IT using Microsoft Defender for Cloud Apps

Develop a methodology for patching and updating systems| Continuously educate your users

Evolve your organization’s SecOps capabilities
...
Description automatically generated](../media/article-6-rapidly-modernize-your-security-posture-05.png)
...
Description automatically generated with medium confidence](../media/article-6-rapidly-modernize-your-security-posture-06.png)
...
In Stage 1, you begin to understand your current security posture. This is also the stage in which you start conversations across your leadership team and organization to learn what Zero Trust is and how it aligns with business strategy and objectives. 
...
For each scenario, consider the communication strategy for both public and internal communications. Your plan should enable you to communicate responsibly in compliance with the regulations of your government and industry. Your response should also reduce the amount of information that you might inadvertently share with attackers.

 

For each scenario, evaluate the internal state of readiness to respond for IT and business teams and when an external response team such as Microsoft Detection and Response Team (DART) or another breach partner is required to either increase operational readiness/cyber resilience or respond to an incident if internal teams become overwhelmed.
...
![Picture 1944237247](../media/article-6-rapidly-modernize-your-security-posture-07.png)

 

## **Implement basic hygiene**

This stage also includes implementing basic hygiene practices. According to the [Microsoft Digital Defense Report](https://www.microsoft.com/en-us/security/business/microsoft-digital-defense-report-2022) (2022), “Although nation state actors can be technically sophisticated and employ a wide variety of 

tactics, their attacks can often be mitigated by good cyber hygiene.” The report estimates, “Ninety -

eight percent of attacks can be stopped with basic hygiene measures in place.”
...
| Inventory your digital estate| [How do you manage IT asset inventory and documentation?](https://www.linkedin.com/advice/1/how-do-you-manage-asset-inventory-documentation) (LinkedIn article).
...
[Does Patching Make Perfect?](https://www.infosecurity-magazine.com/opinions/patching-perfect/) (Infosecurity Magazine) |
...
![image](../media/article-6-rapidly-modernize-your-security-posture-08.png)

 

<can we insert an audio file to voice the graphic instead of repeating with a table?>
