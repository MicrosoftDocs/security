...
- The whitepaper [Zero Trust for the Microsoft identity platform developer](https://aka.ms/ztdev) explains in detail how to approach Zero Trust identity using the Microsoft identity platform.
