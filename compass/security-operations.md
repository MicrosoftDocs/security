...
-   **Prioritizing** security investments into systems that have high intrinsic
    value (likely targets or high business impact) and access to many systems or
...
To complement the broad visibility of a centralized SIEM (such as Azure Sentinel,
