...
- Microsoft Incident Response team (formerly DART) ransomware [approach](/security/ransomware/incident-response-playbook-dart-ransomware-approach) and [case study](dart-ransomware-case-study.md)
