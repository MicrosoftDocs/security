...
description: Independent software vendors (ISVs) can integrate their solutions with Azure Security Center to help customers adopt a Zero Trust model and keep their organizations secure.
ms.date: 09/17/2021
ms.service: security
author: memildin
manager: rkarlin
...
This integration guide includes strategy and instructions for integrating with [Azure Security Center](/azure/security-center/security-center-introduction) and its integrated cloud workload protection platform (CWPP), [Azure Defender](/azure/security-center/azure-defender).
...
### Security Center's zero trust features
...
|---------|---------|
|Assess compliance | In Security Center, every subscription automatically has the [Azure Security Benchmark security initiative assigned](/azure/security-center/security-policy-concept).<br>Using the [secure score tools](/azure/security-center/secure-score-security-controls) and the [regulatory compliance dashboard](/azure/security-center/update-regulatory-compliance-packages) you can very easily get a deep understanding of your customer's security posture. |
|Harden configuration | Assigning security initiatives to subscriptions, and reviewing the secure score, leads you to the [hardening recommendations](/azure/security-center/recommendations-reference) built into Security Center. Security Center periodically analyzes the compliance status of resources to identify potential security misconfigurations and weaknesses. It then provides recommendations on how to remediate those issues.    |
|Employ hardening mechanisms | As well as one-time fixes to security misconfigurations, Security Center offers tools to ensure continued hardening such as:<br>[Just-in-time (JIT) virtual machine (VM) access](/azure/security-center/just-in-time-explained)<br>[Adaptive network hardening](/azure/security-center/security-center-adaptive-network-hardening)<br>[Adaptive application controls](/azure/security-center/security-center-adaptive-application). |
|Set up threat detection  | Security Center offers an integrated cloud workload protection platform (CWPP), Azure Defender.<br>Azure Defender provides advanced, intelligent, protection of Azure and hybrid resources and workloads.<br>One of the Azure Defender plans, Azure Defender for servers, includes a native integration with [Microsoft Defender for Endpoint](/microsoft-365/security/defender-endpoint/).<br>Learn more in [Introduction to Azure Defender](/azure/security-center/azure-defender). |
|Automatically block suspicious behavior | Many of the hardening recommendations in Security Center offer a *deny* option. This feature lets you prevent the creation of resources that don't satisfy defined hardening criteria. Learn more in [Prevent misconfigurations with Enforce/Deny recommendations](/azure/security-center/prevent-misconfigurations).  |
|Automatically flag suspicious behavior | Azure Defender's security alerts are triggered by advanced detections. Security Center prioritizes and lists the alerts, along with the information needed for you to quickly investigate the problem. Security Center also provides detailed steps to help you remediate attacks. For a full list of the available alerts, see [Security alerts - a reference guide](/azure/security-center/alerts-reference).|
|||

### Protect your  Azure PaaS services with Security Center
With Security Center enabled on your subscription, and Azure Defender enabled for all available resource types, you'll have a layer of intelligent threat protection - powered by [Microsoft Threat Intelligence](https://go.microsoft.com/fwlink/?linkid=2128684) - protecting  resources in Azure Key Vault, Azure Storage, Azure DNS, and other Azure PaaS services. For a full list, see [What resource types can Azure Defender secure?](/azure/security-center/azure-defender#what-resource-types-can-azure-defender-secure).
...
Security Center's [workflow automation](/azure/security-center/workflow-automation) feature lets you automate responses to Security Center triggers. 
...
### Integrate Security Center with your SIEM, SOAR, and ITSM solutions
...
Security Center natively integrates with [Azure Sentinel](/azure/sentinel/overview), Microsoft's cloud-native, security information event management (SIEM) and security orchestration automated response (SOAR) solution.

There are two approaches to ensuring your Security Center data is represented in Azure Sentinel:

- **Sentinel connectors** - Azure Sentinel includes built-in connectors for Azure Security Center at the subscription and tenant levels:
    - [Stream alerts to Azure Sentinel at the subscription level](/azure/sentinel/connect-azure-security-center.md)
    ...
    > [!TIP]
    > Learn more in [Connect Azure Defender alerts from Azure Security Center](/azure/sentinel/connect-azure-security-center.md).

- **Stream your audit logs** - An alternative way to investigate Security Center alerts in Azure Sentinel is to stream your audit logs into Azure Sentinel:
...
Use Security Center's [continuous export](/azure/security-center/continuous-export) feature to connect Security Center with Azure monitor via Azure Event Hubs and stream alerts into **ArcSight**, **SumoLogic**, Syslog servers, **LogRhythm**, **Logz.io Cloud Observability Platform**, and other monitoring solutions.
...
### Integrate Security Center with an Endpoint Detection and Response (EDR) solution
...
Learn more in [Endpoint protection assessment and recommendations in Azure Security Center](/azure/security-center/security-center-endpoint-protection).

### Apply your Zero Trust strategy to hybrid and multi cloud scenarios

With cloud workloads commonly spanning multiple cloud platforms, cloud security services must do the same.

Azure Security Center protects workloads wherever they're running: in Azure, on-premises, Amazon Web Services (AWS), or Google Cloud Platform (GCP).

#### Integrate Security Center with on-premises machines

To secure hybrid cloud workloads, you can extend Security Center's protections by connecting  on-premises machines to [Azure Arc enabled servers](/azure/azure-arc/servers/overview).

Learn about how to connect machines in [Connect your non-Azure machines to Security Center](/azure/security-center/quickstart-onboard-machines?pivots=azure-arc).

#### Integrate Security Center with other cloud environments

To view the security posture of **Amazon Web Services** machines in Security Center, onboard  AWS accounts into Security Center. This will integrate AWS Security Hub and Azure Security Center for a unified view of Security Center recommendations and AWS Security Hub findings and provide a range of benefits as described in  [Connect your AWS accounts to Azure Security Center](/azure/security-center/quickstart-onboard-aws).
