...
| **Integration with the Microsoft identity platform** | Use SDKs to connect applications with Microsoft Entra ID, enabling modern authentication protocols such as OAuth 2.0 and OpenID Connect. | [Microsoft identity platform overview \| Azure Docs](/entra/identity-platform/v2-overview) |
