...
:::image type="content" source="media/hybrid-identity.png" alt-text="Components of directory synchronization for Microsoft 365.":::
...
See [Hybrid identities](prepare-for-directory-synchronization.md) for more information.
