...
Building a strong security posture for AI involves working within your organization, especially leaders across your organization, to develop a strategy and a set of priorities and objectives. You then identify the technical work necessary to achieve the objectives and lead the various teams to accomplish them. The articles in this library provide a methodology with guidance that is specific to AI: 
  ...
  - **Discover** the AI apps that are being used in your organization, including the types of data these are using. 
  - **Protect** the usage of AI tools in your organization. This involves AI-specific data protection capabilities as well as ensuring your organization has implemented strong threat protection. 
...
Currently, the most common security incidents in AI include: 
 ...
 - Non-compliance — Regulations, including emerging AI regulations, can increase uncertainty. Non-compliant AI adoption can increase liability. 
...
| 3 | Out of curiosity, Adele wants to see what ChatGPT would summarize, so she pastes the content of the file into ChatGTP. | There is no data loss prevention (DLP) in place to prevent data leakage to consumer AI apps.|
| 4 | The project details were prematurely revealed, resulting in data breaches. Consequently, Contoso banned all AI apps in the workplace. | Banning consumer AI outright can lead to increased dark usage.|
...
| 4 | Some AI apps leverage personal data with no standard guardrails to assess risks.| No risk assessment in place. |
...
## 5 steps to implement effective security for AI 
...
All security guidance for AI provided by Microsoft is anchored to Zero Trust principles. By following security guidance recommended for GenAI, you are building a strong Zero Trust foundation.  
...
Follow the guidance in this series of articles to learn more about securing AI and to identify and implement capabilities to achieve your organization’s objectives.  
 ...
 - Protect AI data and apps 
 - Govern your organization’s use of AI apps and data 
