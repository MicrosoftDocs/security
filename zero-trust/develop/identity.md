...
- The [Adopting Zero Trust into your apps](https://www.microsoft.com/en-us/security/content-library/SkillingPath/Details/6541ecb8-fb85-44a5-bdd4-397bf2bb52f9) skilling path includes two useful  whitepapers:
  ...
  - [Adopting a Zero Trust approach to Identity in line-of-business apps](https://azure.microsoft.com/en-us/resources/zero-trust-identity-line-of-business-apps/) provides guidance that is tailored to apps that are built by or for a company for use within that same company. 
