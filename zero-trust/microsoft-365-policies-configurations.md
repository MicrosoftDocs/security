---
title: Zero Trust identity and device access configurations
...
:::image type="content" source="media/zero-trust-architecture.png" alt-text="The Microsoft Zero Trust architecture" lightbox="media/zero-trust-architecture.png":::
...
:::image type="content" source="media/M365-idquality-threetiers.png" alt-text="The Security cone" lightbox="media/M365-idquality-threetiers.png":::
...
[:::image type="content" source="media/zero-trust-id-device-protection-model-thumbnail.png" alt-text="Thumb image for Zero Trust Identity and device protection for Microsoft 365 poster.":::](../../downloads/MSFT_cloud_architecture_identity&device_protection.pdf) <br> [View as a PDF](../../downloads/MSFT_cloud_architecture_identity&device_protection.pdf) \| [Download as a PDF](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/downloads/MSFT_cloud_architecture_identity&device_protection.pdf)  \| [Download as a Visio](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/downloads/MSFT_cloud_architecture_identity&device_protection.vsdx)
...
:::image type="content" source="media/security-triad.png" alt-text="The Security triad balancing security, functionality, and ease of use" lightbox="media/security-triad.png":::
...
:::image type="content" source="media/identity-device-access-components.png" alt-text="The Components of Zero Trust identity and device access" lightbox="media/identity-device-access-components.png":::
...
:::image type="content" source="media/identity-device-access-steps.png" alt-text="The steps to configure Zero Trust identity and device access" lightbox="media/identity-device-access-steps.png":::
