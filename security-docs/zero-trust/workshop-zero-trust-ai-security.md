...
**Protect sensitive data in AI interactions**  |  Ensure that sensitive data is not exposed or misused when submitted to AI systems (prompts) or used for grounding. <br/><br/>Apply data classification, labeling, and data loss prevention (DLP) policies to control what data can be accessed or used by AI services.
**Prevent data leakage and oversharing through AI outputs**  |  Monitor and restrict the sharing of sensitive information generated by AI systems. <br/><br/>Apply policies to block or limit risky output scenarios, including copying, exporting, or sharing AI-generated content containing sensitive data.
**Control AI-generated content and downstream usage**  |   Govern how AI-generated content is stored, shared, and reused. <br/><br/>Ensure outputs comply with organizational policies, including handling of sensitive, confidential, or regulated information.
**Secure AI-integrated applications and workflows**  |   Protect applications that integrate AI capabilities by enforcing proper authentication, authorization, and data access controls. <br/><br/>Ensure AI features follow the same Zero Trust principles as other workloads and do not introduce unintended data exposure paths.
**Protect connected data and grounding sources**  |   Ensure that data accessed by AI systems such as Microsoft Graph, enterprise data stores, and connected services—is properly secured. <br/><br/>Prevent over-permissioned access that could lead to unintended data exposure through AI responses.
**Monitor AI activity and usage patterns**  |   Gain visibility into how AI tools are being used across the organization. <br/><br/>Track usage patterns, detect anomalies, and identify risky behaviors such as excessive data access or unusual interaction patterns.
**Integrate AI signals into security operations (SecOps)**  |  Incorporate AI-related events, alerts, and data risks into centralized monitoring and response workflows. <br/><br/>Correlate AI activity with identity, device, and data signals to detect and respond to potential threats.
