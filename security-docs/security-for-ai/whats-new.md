...
|Microsoft Entra  | - [Microsoft Entra Agent ID](https://review.learn.microsoft.com/en-us/entra/agent-id/identity-platform/what-is-agent-id-platform?branch=release-ignite-entra-docs-pr) - Identity and access management capabilities specifically designed for AI agents, applying Zero Trust principles to autonomous systems.<br>- [Microsoft Entra Agent Platform](https://review.learn.microsoft.com/en-us/entra/agent-id/identity-platform/what-is-agent-id-platform?branch=release-ignite-entra-docs-pr) - A developer-first platform for managing AI agent identities and access<br> - Agent risk management in Microsoft Entra ID Protection<br>- [AI Prompt Shield](/entra/global-secure-access/how-to-ai-prompt-shield) - Real-time blocking of prompt injection attacks at the network layer<br>- Specialized roles for Agent ID management |
