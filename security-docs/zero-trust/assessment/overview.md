...
Use the Zero Trust Assessment module to run an automated security assessment. It checks your tenant configuration and recommends ways to improve security. The automated assessment helps you act quickly, reevaluate existing tenant security settings, and make changes ahead of product updates. 
