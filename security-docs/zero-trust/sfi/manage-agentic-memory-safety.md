...
| Agentic AI with using persistent context (includes agents.md, ai notes, etc.) | Apply retrieval-time Prompt Shields to detect indirect attacks before injecting memory into reasoning context. | [Prompt Shields in Azure AI Content Safety](s/azure/ai-services/content-safety/concepts/jailbreak-detection) |
