...
:::image type="complex" source="../media/diagram-multitenant-app-external-identities-inline" alt-text="Diagram shows how enterprises invite guest users to their tenant." lightbox="../media/diagram-multitenant-app-external-identities-expanded.png":::
