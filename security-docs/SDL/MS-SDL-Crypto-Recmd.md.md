...
should never be a constant value. See <span class="underline">Random
Number</span> <span class="underline">Generators</span> for
...
o WinHTTP apps should be built with
[<span class="underline">WinHttpSetOption</span>
<span class="underline">
</span>](https://msdn.microsoft.com/en-us/library/windows/desktop/aa384114\(v=vs.85\).aspx)<span class="underline">in
order</span> to support TLS 1.2
  ...
  - Certificate Validation (as used in restricted certificate validation
    for code signing or SSL/TLS/DTLS): CAPI2 API; for

> example,
> [<span class="underline">CertGetCertificateChain</span>](https://msdn.microsoft.com/en-us/library/windows/desktop/aa376078\(v=vs.85\).aspx)
> and [<span class="underline">CertVerifyCertificateChainPolicy</span>
...
*Windows Store Apps* Use the classes in

the
[<span class="underline">Windows.Security.Cryptography</span>](https://msdn.microsoft.com/en-us/library/windows/apps/windows.security.cryptography.aspx)
and
