...
:::image type="content" source="../media/screenshot-application-permissions-requested-consent-prompt.png" alt-text="Permissions requested dialog example highlights component building blocks as described in above-linked Azure AD application consent experience article" :::
