...
| --- | --- | --- |
| Microsoft Entra ID / Microsoft Purview | [Microsoft Entra ID and Mirosoft Purview supported roles](/copilot/security/authentication#microsoft-entra-and-microsoft-purview-roles) | These Microsoft Entra and Microsoft Entra roles inherit the **Copilot owner** role in Security Copilot. Only use these privileged roles to onboard Security Copilot to your organization. |
