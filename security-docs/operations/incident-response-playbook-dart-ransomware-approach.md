...
- [How Microsoft Incident Response uses Microsoft security services](#how-dart-uses-microsoft-security-services)

- [The Microsoft Incident Response approach to conducting ransomware incident investigations](#the-dart-approach-to-conducting-ransomware-incident-investigations)

- [Microsoft Incident Response recommendations and best practices](#dart-recommendations-and-best-practices)
...
- [A guide to combatting human-operated ransomware: Part 1 (September 2021)](https://www.microsoft.com/security/blog/2021/09/20/a-guide-to-combatting-human-operated-ransomware-part-1/)
  ...
  Key steps on how Microsoft's Microsoft Incident Response conducts ransomware incident investigations.
