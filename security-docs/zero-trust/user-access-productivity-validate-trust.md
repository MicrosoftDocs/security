...
| <input type="checkbox" /> | 5. Implement a Microsoft Purview information protection solution and integrate with Conditional Access policies. | Identity Security Admin | [Use sensitivity labels to protect content](/purview/sensitivity-labels-teams-groups-sites) |
