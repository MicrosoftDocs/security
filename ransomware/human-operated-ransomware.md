...
- - Microsoft's Detection and Response Team (DART) ransomware [approach and best practices](../operations/incident-response-playbook-dart-ransomware-approach.md) and [case study](dart-ransomware-case-study.md)
