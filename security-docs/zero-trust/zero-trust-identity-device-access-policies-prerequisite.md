...
|[Configure network locations](/entra/identity/conditional-access/concept-assignment-network). Microsoft Entra ID Protection collects and analyzes all available session data to generate a risk score. We recommend you specify your organization's public IP ranges for your network in the Microsoft Entra ID named locations configuration. Traffic from these ranges gets a reduced risk score, and traffic from outside these ranges gets a higher risk score.||Microsoft 365 E3 or E5|
