...
- Cloud Service Provider Native Controls ([Azure Firewall](/services/azure-firewall/) + [Web Application Firewall (WAF)](https://docs.microsoft.com/azure/application-gateway/waf-overview))
