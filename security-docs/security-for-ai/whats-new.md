...
|
|Microsoft Entra  | - [Microsoft Entra Agent ID](/entra/agent-id/identity-platform/what-is-agent-id-platform) - Identity and access management capabilities specifically designed for AI agents, applying Zero Trust principles to autonomous systems.<br>- [Conditional Access for Agent ID](/entra/identity/conditional-access/agent-id?tabs=custom-security-attributes) - Extends the same Zero Trust conditional access controls that already protect human users and apps to your agents. <br>- [Microsoft Entra Agent Platform](/entra/agent-id/identity-platform/what-is-agent-id-platform) - A developer-first platform for managing AI agent identities and access<br> - [Microsoft Entra Agent Registry](/entra/agent-id/identity-platform/what-is-agent-registry) -  Provides a complete inventory of all agents used in your organization, including Microsoft and third-party agents. <br> - [Agent risk management in Microsoft Entra ID Protection](/entra/id-protection/concept-risky-agents)<br>- [AI Prompt Shield](/entra/global-secure-access/how-to-ai-prompt-shield) - Real-time blocking of prompt injection attacks at the network layer<br>- [Specialized roles for Agent ID management](/entra/agent-id/identity-platform/agent-owners-sponsors-managers) |
|Microsoft Defender | [Security posture management and threat protection for agents](https://techcommunity.microsoft.com/blog/microsoft-security-blog/start-secure-and-stay-secure-on-your-ai-agent-journey-with-microsoft-defender/4469430)|
