...
If you're a larger organization that is using a Microsoft 365 hybrid identity model, you have more verification options. If you have the security infrastructure already in place for a stronger secondary authentication method, [set up MFA](/microsoft-365/admin/security-and-compliance/set-up-multi-factor-authentication?view=o365-worldwide) and configure each dedicated privileged account for the appropriate verification method.
...
[For more information, see [MFA for Microsoft 365.](/microsoft-365/admin/security-and-compliance/multi-factor-authentication-microsoft-365?view=o365-worldwide)
...
- [Prerequisites](/microsoft-365/security/office-365-security/identity-access-prerequisites?view=o365-worldwide)
- [Common identity and device access policies](/microsoft-365/security/office-365-security/identity-access-policies?view=o365-worldwide)
...
[:::image type="content" source="media/microsoft-365-secure-sign-in.png" alt-text="Protect your Microsoft 365 user accounts":::](microsoft-365-secure-sign-in.md)
